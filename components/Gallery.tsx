...
const Gallery = () => {
  ...
  const categories = ["Барлығы", "Пейзаждар", "Шың", "Табиғат", "Үңгірлер"]
  const [activeCategory, setActiveCategory] = useState("Барлығы")

  const filteredImages = activeCategory === "Барлығы" 
    ? galleryImages 
      ...
      <div className="container-max">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            <span className="text-gradient">Қазығұрттың</span> галереясы
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Қазығұрт тауының сұлулығына біздің керемет фотосуреттер 
            жинағы арқылы сүңгіп кіріңіз
          </p>
        </motion.div>
